...
layout: post
category : mantras
tags : [NSView, NSWIndow, Cocoa, wisdom, confusing]
---
{% include JB/setup %}

I have always been somewhat beguiled by that here nor there nature of Anna's window controller and a few controller etc.  Sometimes people use them, sometimes they don't… Apple seems to want you to use them yet documentation is all a little bit iffy.  I sometimes stumble into correctly implementing them - to nice effect - but usually I sort of avoid the topic, and just sort hope I can figure out some other way To do it that is more straightforward In my head, with varying success.  My mission in this space to lift veils of confusion That tend to obscure the "3000 foot view" around __these kinds of things__ - and I found the following post on CocoDev To be refreshingly straightforward, matter of fact, Well stated, And out of the ordinary. It also helped that it kind of put my mind at ease, That it wasn't a fundamental personality disorder / genetic flaw in my flight/fright coping mechanisms that let me astray from these somewhat illogical constructs.

    ---
    post :  Erik M. BuckRe: How to hide a window?Sep 21 2001, 06:06
    body : The document and window controller architecture is relatively recent.  We
