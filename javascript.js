...
// optional URL params 		 user: github username to use instead of whatever's hardcoded below
// 							cache: set to false to disable localStorage saving

// $.fn.ready(function(){
var docReady = function(){   console.log('at least i got called')
	...
	$('td').hover(
  			function () {
    			...
    			$(this).closest('tbody').css('background','yellow')//closest('tbody')

  			}, 
  			function () {
    			$(this).closest('tbody').css('background','red');//closest
  	})
	// var saved;
	// $('thead').hover(function() { saved = $(this).css('background-color').
	// 	// Stuff to do when the mouse enters the element;
	// }, function() { $(this).css('background-color
	// 	// Stuff to do when the mouse leaves the element;
	// });
	// $(".repos thead tr").children().data('sort', 'string')
	// $(".repos").tablesorter({
	// 	    theme : 'blue',
